...
Train ~300M models on the same experiments

1. gradient accumulation for larger batch size
2. autocast / grad scaling for mixed precision training
3. move to dataloaders for faster data loading
4. train in f16 if possible??
