...
Here's a second table whose purpose is to hold experiments which were performed with autocast and rope and stuff. I use a sequence length of 1024 here so the perplexity is a bit higher. 100M tokens.
